...
{
    [Table("BankSafeDepositBoxDetail_Import")]
    public class BankSafeDepositBox
    {
        [Key]
        /// <summary>
        ///自動序號
        ...
        ///資料提供日(轉換過)
        /// </summary>
        public DateTime? DataProvidedTime_Cov { get; set; }
        /// <summary>
        ///承租日(轉換過)
        /// </summary>
        public DateTime? RentDate_Cov { get; set; }
        ...
        ///退租日(轉換過)
        /// </summary>
        public DateTime? LeaseCancellationDate_Cov { get; set; }
        /// <summary>
        ///備註
        /// </summary>
