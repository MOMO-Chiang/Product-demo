...
{
    public class CryptoPersonalInfoIPRepository : RepositoryBase<CryptoPersonalInfoLoginIPList_API>, ICryptoPersonalInfoIPRepository    //ICryptoPersonalInfoIPRepository
    {
        public CryptoPersonalInfoIPRepository(IDbConnectionFactory dbConnectionFactory, string connectionName)
            : base(dbConnectionFactory, connectionName)
        {

        }
        
        public Tuple<IEnumerable<CryptoPersonalInfoLoginIPList_API>, int> SearchIP(string PersonalInfoId, PaginationWithSortedQueryModel paginated)
        {
