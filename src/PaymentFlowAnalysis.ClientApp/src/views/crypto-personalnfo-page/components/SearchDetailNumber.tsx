...
/** DataTable 欄位名稱 */
export type CryptoPersonalInfoDetailNumberTableField = keyof PersonalDetailNumberShowModalData;
...
export default function SearchDetailNumberModal(props: any) {
  ...
  //   (state: AppState) => state.pages.CryptoPersonalInfo.CryptoPersonalSearchDetailNumberParams,
  // );

  /** DetailNumber資料 */
  const DetailNumberData = useSelector((state: AppState) => state.pages.CryptoPersonalInfo.DetailNumberData);
  /** 分頁資訊資料 */
  ...
  const renderColumn: RenderColumnFunc<PersonalDetailNumberShowModalData, CryptoPersonalInfoDetailNumberTableField> = ({
    field,
    data,
  }) => {
