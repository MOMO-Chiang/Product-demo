...
/** DataTable 欄位名稱 */
export type CryptoPersonalInfoWallerAddressTableField = keyof PersonalWallerAddressShowModalData;
...
export default function SearchWallerAddressModal(props: any) {
  ...
  const CryptoPersonalSearchWallerAddressParams = useSelector(
    (state: AppState) => state.pages.CryptoPersonalInfo.CryptoPersonalSearchWallerAddressParams,
  );

  /** WallerAddress資料 */
  const WallerAddressData = useSelector((state: AppState) => state.pages.CryptoPersonalInfo.wallerAddressData);

  /** 分頁資訊資料 */
  const paginatedInfo = useSelector((state: AppState) => state.pages.CryptoPersonalInfo.paginatedWallerAddressInfo);
  ...
  const renderColumn: RenderColumnFunc<PersonalWallerAddressShowModalData, CryptoPersonalInfoWallerAddressTableField> = ({
    field,
    data,
  }) => {
