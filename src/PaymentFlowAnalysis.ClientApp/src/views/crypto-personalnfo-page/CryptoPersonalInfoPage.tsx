...
import { CRYPTO_PERSONAL_INFO_STORAGE_KEY, DEFAULT_PAGE, PAGE_SIZE_OPTIONS } from '@shared/constants';
...
/** 「模板頁面」元件 */
export const CryptoPersonalInfoPage = () => {
  //#region Hooks
  ...
  const currentFetchOrderNumberListsParams = useSelector(
    (state: AppState) => state.pages.CryptoPersonalInfo.currentFetchOrderNumberListParams,
  );

  /** 調閱主序號資料 */
  const CryptoQueryMaster = useSelector((state: AppState) => state.pages.CryptoPersonalInfo.CryptoQueryMaster);
  ...
  /** Render Master DataTable Columns */
  ...
  useEffect(() => {
    // 載入畫面時，取得調閱單號列表
    const orderMasterNumber = localStorage.getItem(CRYPTO_PERSONAL_INFO_STORAGE_KEY);
    ...
    setTimeout(() => {
      localStorage.removeItem(CRYPTO_PERSONAL_INFO_STORAGE_KEY);
    }, 100);
        ...
        <form className="container-fluid">
          <div className="row">
            <div className="col-12 col-sm-2 col-md-3 col-lg-3">
              <FormGroup>
                {/* <Label style={{ background: '#e9ecef', border: '1px solid #ced4da', borderRadius: '0.25rem', fontWeight: '400', padding: '0.375rem 0.75rem', alignItems: 'center' }}>錢包地址</Label> */}
                <Label>交易所拋查條件</Label>
                <Select
            ...
            <div className="col-12 col-sm-7 col-md-6 col-lg-6">
              <FormGroup>
                ...
                {/* <textarea
                  name="textarea"
                  id="search_info"
                  value={formData.search_info}
                  onChange={(e) => updateFormData({ search_info: e.target.value })}
                  cols={45}
                  rows={7}
            ...
            <div className="col-12 col-sm-2 col-md-2 col-lg-2">
              <FormGroup>
                ...
                <div className="row">
                  ...
                  {/* <button type="submit" className="btn btn-primary btn-width-lg" disabled={isFetchOrderMasterListsLoading}>
                    開啟代拋查
                  </button> */}
                </div>
              </FormGroup>
        ...
        <form className="container-fluid" onSubmit={handleSearchFormSubmit}>
          ...
          <div className="row">
            <div className="col-12 text-center">
              ...
              <button type="submit" className="btn btn-primary btn-width-xlg" disabled={isFetchOrderMasterListsLoading}>
                個資資料查詢
              </button>
              <img
                src={odsSvg}
