...
/** DataTable 欄位名稱 */
export type RelevantCryptoPersonalInfoDetailNumberTableField = keyof PersonalDetailNumberShowModalData;
...
export default function SearchDetailNumberModal(props: any) {
  ...
  //   (state: AppState) => state.pages.RelevantCryptoPersonalInfo.CryptoPersonalSearchDetailNumberParams,
  // );

  /** DetailNumber資料 */
  const DetailNumberData = useSelector((state: AppState) => state.pages.RelevantCryptoPersonalInfo.DetailNumberData);
  /** 分頁資訊資料 */
  ...
  const renderColumn: RenderColumnFunc<PersonalDetailNumberShowModalData, RelevantCryptoPersonalInfoDetailNumberTableField> = ({
    field,
    data,
  }) => {
