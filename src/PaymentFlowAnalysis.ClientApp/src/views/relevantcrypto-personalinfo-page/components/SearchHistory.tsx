...
import { CryptoPersonalInfo, CryptoQueryDetail, CryptoQueryMaster } from '@shared/types';
import React from 'react';
import { FormEvent, useCallback, useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { fetchHistoryOrderNumberListActionCreator, fetchOrderNumberListActionCreator } from '../actions';
...
export default function SearchHistoryModal() {
  ...
  const currentFetchCryptoPersonalSearchHistoryParams = useSelector(
    (state: AppState) => state.pages.RelevantCryptoPersonalInfo.currentFetchCryptoPersonalSearchHistoryParams,
  );

  /** 個資調閱資料 */
  const HistoryRelevantCryptoPersonalInfo = useSelector(
    (state: AppState) => state.pages.RelevantCryptoPersonalInfo.HistoryRelevantCryptoPersonalInfo,
  );
          ...
          <Card>
            ...
            <Card.Body>
              <DataTable
                ...
                data={HistoryRelevantCryptoPersonalInfo}
