...
export const fetchOrderNumberList = (params: FetchOrderNumberListParams) =>
  AdminHttpRequest.get<FetchOrderNumberListResponse>('/api/cryptopersonalinfo/normal', params);
...
export const downloadOrderNumberListExcel = (params: FetchOrderNumberListParams) =>
  AdminHttpRequest.download('/api/cryptopersonalinfo/normal/export/excel', null, { params, method: 'GET' });

/**
 * 匯出調閱單號資料ods
 */
export const downloadOrderNumberListOds = (params: FetchOrderNumberListParams) =>
  AdminHttpRequest.downloadOds('/api/cryptopersonalinfo/normal/export/excel', null, { params, method: 'GET' });
...
export const fetchHistoryOrderNumberList = (params: FetchCryptoPersonalSearchHistoryParams) =>
  AdminHttpRequest.get<FetchOrderNumberListResponse>('/api/cryptopersonalinfo/history', params);
...
export const getPhoneShowModal = (id: string, type: 'phone', data: CryptoPersonalSearchParams) =>
  AdminHttpRequest.post<FetchPhoneShowModalResponse>(`/api/cryptopersonalinfo/showmodal/${id}/${type}`, data);
...
export const getWallerAddressShowModal = (id: string, type: 'wallerAddress', data: CryptoPersonalSearchParams) =>
  AdminHttpRequest.post<FetchWallerAddressShowModalResponse>(`/api/cryptopersonalinfo/showmodal/${id}/${type}`, data);
...
export const getIPShowModal = (id: string, type: 'ip', data: CryptoPersonalSearchParams) =>
  AdminHttpRequest.post<FetchIPShowModalResponse>(`/api/cryptopersonalinfo/showmodal/${id}/${type}`, data);
...
export const getPictureShowModal = (id: string, type: 'picture', data: CryptoPersonalSearchParams) =>
  AdminHttpRequest.post<FetchPictureShowModalResponse>(`/api/cryptopersonalinfo/showmodal/${id}/${type}`, data);
...
export const getDetailNumberShowModal = (id: string) =>
  AdminHttpRequest.get<FetchDetailNumberShowModalResponse>(`/api/cryptopersonalinfo/SearchDetailNumber/${id}`);
...
export const isCaseMark = (id: string, isCaseMark: boolean) =>
  AdminHttpRequest.patch(`/api/cryptopersonalinfo/${id}/iscasemark`, isCaseMark);
